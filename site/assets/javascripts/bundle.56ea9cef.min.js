...
(() => {
  ...
  var io = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    $ = (e, t) => {
      for (var r in t || (t = {})) yr.call(t, r) && io(e, r, t[r]);
      if (Vt) for (var r of Vt(t)) ao.call(t, r) && io(e, r, t[r]);
      return e;
    };
  var so = (e, t) => {
    var r = {};
    for (var o in e) yr.call(e, o) && t.indexOf(o) < 0 && (r[o] = e[o]);
    if (e != null && Vt)
      for (var o of Vt(e)) t.indexOf(o) < 0 && ao.call(e, o) && (r[o] = e[o]);
    return r;
  };
  var xr = (e, t) => () => (
  ...
  var lo = xr((Er, po) => {
    (function (e, t) {
      typeof Er == "object" && typeof po != "undefined"
        ? t()
      ...
      function e(r) {
        ...
        function p(k) {
          var ft = k.type,
            qe = k.tagName;
          return !!(
            (qe === "INPUT" && a[ft] && !k.readOnly) ||
            (qe === "TEXTAREA" && !k.readOnly) ||
            k.isContentEditable
          );
        }
        function c(k) {
  ...
  var Br = xr((Rt, Yr) => {
     ...
     */ (function (t, r) {
      typeof Rt == "object" && typeof Yr == "object"
        ? (Yr.exports = r())
        : typeof define == "function" && define.amd
          ? define([], r)
          : typeof Rt == "object"
        ...
        var e = {
            686: function (o, n, i) {
              ...
              var ft = function () {
                  ...
                  if ($e) return J($e, { container: V });
                  if (Y) return F === "cut" ? y(Y) : J(Y, { container: V });
                },
                qe = ft;
              function Fe(D) {
                "@babel/helpers - typeof";
              ...
              function Hi(D, A, M) {
                return (A && no(D.prototype, A), M && no(D, M), D);
              }
              function $i(D, A) {
              ...
              function Ri(D, A) {
                return A && (Fe(A) === "object" || typeof A == "function")
                  ? A
                  : Ii(D);
              }
              function Ii(D) {
              ...
              function vr(D, A) {
                ...
                if (A.hasAttribute(M)) return A.getAttribute(M);
              }
              var Fi = (function (D) {
                  $i(M, D);
                  var A = Pi(M);
            ...
            370: function (o, n, i) {
              ...
              function p(u, d, y) {
                ...
                if (a.node(u)) return c(u, d, y);
                if (a.nodeList(u)) return l(u, d, y);
                if (a.string(u)) return f(u, d, y);
                throw new TypeError(
  ...
  function fo(e, t, r) {
    ...
    function u(d, y) {
      (d(y), i.shift(), i.length && p(i[0][0], i[0][1]));
    }
  }
  function uo(e) {
    if (!Symbol.asyncIterator)
...
` +
  ...
  var dt = {
    setTimeout: function (e, t) {
      ...
      return n != null && n.setTimeout
        ? n.setTimeout.apply(n, q([e, t], z(r)))
        : setTimeout.apply(void 0, q([e, t], z(r)));
    },
  ...
  var Mt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (o.isStopped = !1),
        r ? ((o.destination = r), Nt(r) && r.add(o)) : (o.destination = Yi),
        o
      );
    }
    return (
  ...
  var Yi = { closed: !0, next: be, error: Ki, complete: be };
  var bt = (function () {
  ...
  function Eo(e) {
    var t;
    return (t = e != null ? e : Pe.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function Bi(e) {
      ...
      (t.prototype.next = function (r) {
        ...
        ht(function () {
          ...
          if ((o._throwIfClosed(), !o.isStopped)) {
            ...
            try {
              for (
                var a = he(o.currentObservers), s = a.next();
                !s.done;
                s = a.next()
              ) {
                var p = s.value;
  ...
  var Ct = {
    setInterval: function (e, t) {
      ...
      return n != null && n.setInterval
        ? n.setInterval.apply(n, q([e, t], z(r)))
        : setInterval.apply(void 0, q([e, t], z(r)));
    },
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          ...
          n !== null && n > 0
            ...
            : (r.actions.push(this),
              r._scheduled ||
                (r._scheduled = vt.requestAnimationFrame(function () {
      ...
      (t.prototype.recycleAsyncId = function (r, o, n) {
        ...
        o != null &&
          ...
          ((i = a[a.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            o &&
          (vt.cancelAnimationFrame(o), (r._scheduled = void 0));
      }),
      t
    );
  })(gt);
  ...
  function Jt(e) {
    return (
      Symbol.asyncIterator && H(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function Xt(e) {
  ...
  function ea(e) {
    return new j(function (t) {
      var r = e[bt]();
      if (H(r.subscribe)) return r.subscribe(t);
      throw new TypeError(
  ...
  function Ro(e, t) {
    if (e != null) {
      ...
      if (xt(e)) return Ho(e, t);
      if (Bt(e)) return ko(e, t);
      if (Jt(e)) return or(e, t);
      if (er(e)) return $o(e, t);
      if (rr(e)) return Po(e, t);
    }
    throw Xt(e);
  }
  function ue(e, t) {
  ...
  function jo(e) {
    if (e.length === 1) {
      var t = e[0];
      if (ca(t)) return { args: t, keys: null };
      if (fa(t)) {
        var r = ma(t);
        return {
  ...
  var ua = ["addListener", "removeListener"],
    ...
    ha = ["on", "off"];
  function h(e, t, r, o) {
    if ((H(r) && ((o = r), (r = void 0)), o)) return h(e, t, r).pipe(Ze(o));
    var n = z(
        ga(e)
          ? da.map(function (s) {
              return function (p) {
    ...
    return E(function (t, r) {
      ...
      t.subscribe(
        T(
          r,
          function (c) {
            ((o = !0), (n = c), i || U(e(c)).subscribe((i = T(r, s, p))));
          },
          function () {
            ...
            function (a) {
              ...
              try {
                for (var u = he(n), d = u.next(); !d.done; d = u.next()) {
                  var y = d.value;
                  (y.push(a),
                    e <= y.length && ((f = f != null ? f : []), f.push(y)));
                }
              } catch (ee) {
                s = { error: ee };
              } finally {
        ...
        (ft.add(function () {
          ...
          !l &&
            ...
            ((l = new at({
              ...
              error: function (Fe) {
                ((L = !0), X(), (f = Ur(ee, n, Fe)), qe.error(Fe));
              },
              complete: function () {
                ((y = !0), X(), (f = Ur(ee, a)), qe.complete());
              },
            })),
            U(k).subscribe(l)));
      })(c);
  ...
  function w(e, t, r) {
    var o = H(e) || t || r ? { next: e, error: t, complete: r } : e;
    return o
      ? E(function (n, i) {
          var a;
  ...
  var wa = O(h(document.body, "focusin"), h(document.body, "focusout")).pipe(
    _e(1),
    Q(void 0),
    m(() => Ie() || document.body),
    G(1),
  ...
  function Ht(e, t) {
    return C(() =>
      ...
      ).pipe(t ? kt((r) => Le(+!r * t)) : le, Q(e.matches(":hover"))),
    );
  }
  function Jo(e, t) {
    ...
    else if (Array.isArray(t)) for (let r of t) Jo(e, r);
  }
  function x(e, t, ...r) {
  ...
  var Xo = new g(),
    Ta = C(() =>
      ...
      m(() => new ResizeObserver((e) => e.forEach((t) => Xo.next(t)))),
      v((e) => O(Ye, I(e)).pipe(_(() => e.disconnect()))),
      G(1),
    );
  function ce(e) {
  ...
  function tn(e) {
    return O(h(window, "load"), h(window, "resize")).pipe(
      Me(0, me),
      m(() => De(e)),
      Q(De(e)),
    );
  ...
  function ze(e) {
    return O(h(e, "scroll"), h(window, "scroll"), h(window, "resize")).pipe(
      Me(0, me),
      m(() => pr(e)),
      Q(pr(e)),
    );
  ...
  function an() {
    let e = h(window, "keydown").pipe(
      ...
      b(({ mode: t, type: r }) => {
        if (t === "global") {
          let o = Ie();
          if (typeof o != "undefined") return !Oa(o, r);
        }
        return !0;
      }),
      pe(),
  ...
  function vn() {
    return h(window, "resize", { passive: !0 }).pipe(m(bn), Q(bn()));
  }
  function gn() {
    return N([hn(), vn()]).pipe(
  ...
  function xn(e) {
    if (!B("announce.dismiss") || !e.childElementCount) return S;
    if (!e.hidden) {
  ...
  function Qr(e, t) {
    let r = t & 2,
      ...
      n = Object.keys(e.terms)
        .filter((p) => !e.terms[p])
        .reduce((p, c) => [...p, x("del", null, (0, Ln.default)(c)), " "], [])
        .slice(0, -1),
      i = xe(),
  ...
  function Cn(e, t) {
    ...
    return (
      ...
      x(
        ...
        x("ul", { class: "md-version__list" }, e.map(Ra)),
      )
    );
  }
  var Ia = 0;
  function ja(e) {
    let t = N([et(e), Ht(e)]).pipe(
        m(([o, n]) => o || n),
        K(),
      ),
      r = C(() => Zo(e)).pipe(
      ...
      let p = a.pipe(
        ...
        m(([c, l, { size: f }]) => {
          let u = e.getBoundingClientRect(),
            d = u.width / 2;
          if (l.role === "tooltip") return { x: d, y: 8 + u.height };
          if (u.y >= f.height / 2) {
            let { height: y } = ce(l);
            return { x: d, y: -16 - y };
          } else return { x: d, y: 16 + u.height };
        }),
      );
      return (
        N([s, i, p]).subscribe(([c, { offset: l }, f]) => {
  ...
  function fr(e, t, { target$: r, print$: o }) {
    ...
    for (let s of Va(t)) {
      ...
      fe(`:scope > li:nth-child(${p})`, e) &&
        (a.set(p, Tn(p, i)), s.replaceWith(a.get(p)));
    }
    return a.size === 0
      ? S
      : C(() => {
          ...
          return (
            o.pipe(W(p)).subscribe((l) => {
              ((e.hidden = !l), e.classList.toggle("md-annotation-list", l));
              for (let [f, u] of c) l ? Hn(f, u) : Hn(u, f);
            }),
            O(...[...a].map(([, l]) => kn(l, t, { target$: r }))).pipe(
              _(() => s.complete()),
              pe(),
            )
          );
  ...
  function $n(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === "P" && !t.children.length) return $n(t);
    }
  }
  function Pn(e, t) {
    return C(() => {
  ...
  function In(e) {
    if (e.nextElementSibling) {
      let t = e.nextElementSibling;
      if (t.tagName === "OL") return t;
      if (t.tagName === "P" && !t.children.length) return In(t);
    }
  }
  function za(e) {
    return ge(e).pipe(
    ...
    let { matches: r } = matchMedia("(hover)"),
      o = C(() => {
        ...
        if (
          ...
          let l = Sn(c.id);
          (c.insertBefore(l, e),
            B("content.tooltips") && a.push(mt(l, { viewport$ })));
        }
  ...
  function Ka() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? wt("https://unpkg.com/mermaid@11/dist/mermaid.min.js")
      : I(void 0);
  }
  function Wn(e) {
    return (
  ...
  var Vn = x("table");
  function Dn(e) {
    return (e.replaceWith(Vn), Vn.replaceWith(An(e)), I({ ref: e }));
  }
  function Ya(e) {
    let t = e.find((r) => r.checked) || e[0];
    return O(
      ...e.map((r) => h(r, "change").pipe(m(() => R(`label[for="${r.id}"]`)))),
    ).pipe(
      Q(R(`label[for="${t.id}"]`)),
      m((r) => ({ active: r })),
    );
    ...
    return (
      ...
      C(() => {
        ...
        (N([s, ge(e), tt(e)])
          ...
          O(h(i, "click").pipe(m(() => -1)), h(a, "click").pipe(m(() => 1)))
            .pipe(W(p))
            .subscribe((c) => {
              let { width: l } = ce(o);
        ...
        return (
          B("content.tabs.link") &&
            s.pipe(Ce(1), re(t)).subscribe(([{ active: c }, { offset: l }]) => {
                ...
                for (let y of P("[data-tabs]"))
                  for (let L of P(":scope > input", y)) {
                    ...
                    if (X !== c && X.innerText.trim() === f) {
                      (X.setAttribute("data-md-switching", ""), L.click());
                      break;
                    }
                  }
          ...
          s.pipe(W(p)).subscribe(() => {
            for (let c of P("audio, video", e)) c.pause();
          }),
          Ya(n).pipe(
            w((c) => s.next(c)),
            _(() => s.complete()),
  ...
  function Nn(e, { viewport$: t, target$: r, print$: o }) {
    return O(
      ...P(".annotate:not(.highlight)", e).map((n) =>
        Pn(n, { target$: r, print$: o }),
      ),
      ...P("pre:not(.mermaid) > code", e).map((n) =>
        jn(n, { target$: r, print$: o }),
      ),
      ...P("pre.mermaid", e).map((n) => Wn(n)),
      ...P("table:not([class])", e).map((n) => Dn(n)),
      ...P("details", e).map((n) => Fn(n, { target$: r, print$: o })),
      ...P("[data-tabs]", e).map((n) => zn(n, { viewport$: t, target$: r })),
      ...P("[title]", e)
        .filter(() => B("content.tooltips"))
        .map((n) => mt(n, { viewport$: t })),
    );
  }
  function Ba(e, { alert$: t }) {
    return t.pipe(
      v((r) =>
        O(I(!0), I(!1).pipe(Ge(2e3))).pipe(
  ...
  function Ja(e, t) {
    ...
    let o = cr(t),
      n = typeof o != "undefined" ? ze(o) : I({ x: 0, y: 0 }),
  ...
  function Yn(e, { header$: t, main$: r }) {
    return C(() => {
      let o = new g(),
        n = o.pipe(Z(), ie(!0));
      o.pipe(te("active"), He(t)).subscribe(
        ([{ active: a }, { hidden: s }]) => {
          (e.classList.toggle("md-header--shadow", a && !s), (e.hidden = s));
        },
      );
      let i = ue(P("[title]", e)).pipe(
  ...
  function ur(e) {
    return un(new URL("sitemap.xml", e)).pipe(
      m((t) => rs(t, new URL(e))),
      de(() => I(new Map())),
    );
  }
  function os(e, t) {
    if (!(e.target instanceof Element)) return S;
    let r = e.target.closest("a");
    if (r === null) return S;
    if (r.target || e.metaKey || e.ctrlKey) return S;
    let o = new URL(r.href);
    return (
      (o.search = o.hash = ""),
      t.has(`${o}`) ? (e.preventDefault(), I(new URL(r.href))) : S
    );
  }
  function ti(e) {
    let t = new Map();
  ...
  function ns(e) {
    ...
    return We(P("script", r)).pipe(
      v((o) => {
        ...
        } else return ((n.textContent = o.textContent), o.replaceWith(n), S);
      }),
      Z(),
      ie(document),
    );
  ...
  function oi({ location$: e, viewport$: t, progress$: r }) {
    ...
    let i = h(document.body, "click").pipe(
        He(n),
        v(([p, c]) => os(p, c)),
        pe(),
      ),
    ...
    let s = e.pipe(
      te("pathname"),
      v((p) => fn(p, { progress$: r }).pipe(de(() => (lt(p, !0), S)))),
      v(ri),
      v(ns),
      pe(),
    );
  ...
  function ai(e, t) {
    let r = yn(e);
    return (
      O(I(location.protocol !== "file:"), Ne("search"))
        .pipe(
          Ae((o) => o),
          v(() => t),
        )
  ...
  function si(e) {
    ...
    if (!t.has(s)) return;
    let p = Xr(a, s);
    if (!p || !t.has(p.href)) return;
    let c = Xr(a, r);
    if (c) return ((c.hash = o.hash), (c.search = o.search), c);
  }
  function Xr(e, t) {
    try {
      return new URL(e, t);
  ...
  function ps(e) {
    let t;
    for (let r of e) t === void 0 ? (t = r) : (t = t.slice(0, cs(t, r)));
    return t != null ? t : "";
  }
  function ci({ document$: e }) {
    ...
    (r
      ...
      e.pipe(v(() => o)).subscribe((n) => {
        ...
        if (a) for (let p of ae("outdated")) p.hidden = !1;
      }));
  }
  function ls(e, { worker$: t }) {
    ...
    let o = et(e),
      n = O(t.pipe(Ae(It)), h(e, "keyup"), o).pipe(
        m(() => e.value),
        K(),
      );
    return N([n, o]).pipe(
  ...
  function li(e, { worker$: t, query$: r }) {
    ...
    (Ne("search").subscribe((l) =>
      s.setAttribute("role", l ? "list" : "presentation"),
    ),
      o
        .pipe(re(r), Wr(t.pipe(Ae(It))))
  ...
  function fi(e, { worker$: t, keyboard$: r }) {
    let o = new g(),
      n = Se("search-query"),
      i = O(h(n, "keydown"), h(n, "focus")).pipe(
        ve(se),
        m(() => n.value),
        K(),
      );
  ...
  function ui(e, { index$: t, keyboard$: r }) {
    ...
    try {
      ...
      let s = pi(i, { worker$: n });
      return O(s, li(a, { worker$: n, query$: s })).pipe(
        Re(
          ...ae("search-share", e).map((p) => mi(p, { query$: s })),
          ...ae("search-suggest", e).map((p) =>
            fi(p, { worker$: n, keyboard$: r }),
          ),
        ),
      );
    } catch (n) {
      return ((e.hidden = !0), Ye);
    }
  }
  function di(e, { index$: t, location$: r }) {
    return N([
      ...
      m(([o, n]) => ii(o.config)(n.searchParams.get("h"))),
      m((o) => {
        var a;
        let n = new Map(),
      ...
      return (
        ...
        ue(P("label[tabindex]", e))
          ...
          .subscribe((l) => {
            ...
            R(`[aria-labelledby="${l.id}"]`).setAttribute(
              "aria-expanded",
              `${f.checked}`,
            );
          }),
  ...
  function bi(e, t) {
    ...
    return st(
      je(`${r}/releases/permalink/latest`).pipe(
        de(() => S),
    ...
    return (
      ...
      (us = C(() => {
        ...
        if (ae("consent").length) {
          ...
          if (!(o && o.github)) return S;
        }
        return vi(e.href).pipe(
  ...
  function yi(e, t) {
    return C(() => {
      ...
      return (
        ...
        (B("navigation.tabs.sticky") ? I({ hidden: !1 }) : hs(e, t)).pipe(
          w((o) => r.next(o)),
          _(() => r.complete()),
          m((o) => $({ ref: e }, o)),
        )
              ...
              t.pipe(
                Fr(
                  ([l, f], { offset: { y: u }, size: d }) => {
                    ...
                    for (; f.length; ) {
                      let [, L] = f[0];
                      if (L - c < u || y) l = [...l, f.shift()];
                      else break;
                    }
                    for (; l.length; ) {
                      let [, L] = l[l.length - 1];
                      if (L - c >= u && !y) f = [l.pop(), ...f];
                      else break;
                    }
                    return [l, f];
                  },
        ...
        i.pipe(
          ...
          if (l.offsetHeight) {
            ...
            if (typeof f != "undefined") {
              let u = l.offsetTop - f.offsetTop,
                { height: d } = ce(f);
              f.scrollTo({ top: u - d / 2, behavior: c });
            }
          }
        });
      }
  ...
  function Ei(e, { viewport$: t, header$: r, main$: o, target$: n }) {
    ...
    return (
      ...
      vs(e, { viewport$: t, main$: o, target$: n }).pipe(
        w((s) => i.next(s)),
        _(() => i.complete()),
        m((s) => $({ ref: e }, s)),
      )
      ...
      .pipe(
        ...
        ne((r) => {
          ...
          return (
            (n.title = o),
            B("content.tooltips")
              ? mt(n, { viewport$: t }).pipe(
                  W(e.pipe(Ce(1))),
                  _(() => n.removeAttribute("title")),
                )
              : S
          );
        }),
  ...
  function Ti({ document$: e, tablet$: t }) {
    e.pipe(
      ...
      ne((r) =>
        h(r, "change").pipe(
          Vr(() => r.classList.contains("md-toggle--indeterminate")),
          m(() => r),
        ),
      ),
      re(t),
  ...
  function Si({ document$: e }) {
    e.pipe(
      v(() => P("[data-md-scrollfix]")),
      w((t) => t.removeAttribute("data-md-scrollfix")),
      b(gs),
      ne((t) => h(t, "touchstart").pipe(m(() => t))),
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  function ys() {
    return location.protocol === "file:"
      ? wt(`${new URL("search/search_index.js", eo.base)}`).pipe(
          m(() => __index),
          G(1),
        )
      : je(new URL("search/search_index.json", eo.base));
  }
  ...
  B("navigation.instant") &&
    oi({ location$: Ft, viewport$: Oe, progress$: oo }).subscribe(ot);
  var Li;
  ((Li = eo.version) == null ? void 0 : Li.provider) === "mike" &&
    ci({ document$: ot });
  O(Ft, Ot)
    .pipe(Ge(125))
    .subscribe(() => {
  ...
  wi({ viewport$: Oe, document$: ot });
  Ti({ document$: ot, tablet$: hr });
  Si({ document$: ot });
  Oi({ viewport$: Oe, tablet$: hr });
  var rt = Kn(Se("header"), { viewport$: Oe }),
    jt = ot.pipe(
      m(() => Se("main")),
      v((e) => Gn(e, { viewport$: Oe, header$: rt })),
      G(1),
    ),
    xs = O(
      ...ae("consent").map((e) => En(e, { target$: Ot })),
      ...ae("dialog").map((e) => qn(e, { alert$: ro })),
      ...ae("palette").map((e) => Jn(e)),
      ...ae("progress").map((e) => Xn(e, { progress$: oo })),
      ...ae("search").map((e) => ui(e, { index$: Ai, keyboard$: to })),
      ...ae("source").map((e) => gi(e)),
    ),
    Es = C(() =>
      O(
        ...ae("announce").map((e) => xn(e)),
        ...ae("content").map((e) =>
          Nn(e, { viewport$: Oe, target$: Ot, print$: _i }),
        ),
        ...ae("content").map((e) =>
          B("search.highlight") ? di(e, { index$: Ai, location$: Ft }) : S,
        ),
        ...ae("header").map((e) =>
          Yn(e, { viewport$: Oe, header$: rt, main$: jt }),
        ),
        ...ae("header-title").map((e) => Bn(e, { viewport$: Oe, header$: rt })),
        ...ae("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? zr(Mi, () => Zr(e, { viewport$: Oe, header$: rt, main$: jt }))
            : zr(hr, () => Zr(e, { viewport$: Oe, header$: rt, main$: jt })),
        ),
        ...ae("tabs").map((e) => yi(e, { viewport$: Oe, header$: rt })),
        ...ae("toc").map((e) =>
          xi(e, { viewport$: Oe, header$: rt, main$: jt, target$: Ot }),
        ),
        ...ae("top").map((e) =>
          Ei(e, { viewport$: Oe, header$: rt, main$: jt, target$: Ot }),
        ),
      ),
    ),
    Ci = ot.pipe(
